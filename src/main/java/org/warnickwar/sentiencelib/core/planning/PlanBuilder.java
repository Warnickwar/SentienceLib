...
public interface PlanBuilder {
     ...
     *                  This includes Desires collected from {@link org.warnickwar.sentiencelib.core.context.Context Context}.
     * @param actions The set of Actions which the Agent has at the time of the request.
     *                  This includes Actions collected from {@link org.warnickwar.sentiencelib.core.context.Context Context}.
